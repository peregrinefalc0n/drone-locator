...
channel_freq_range_list = {
    "A": [[5850, 5880], [5830, 5860], [5810, 5840], [5790, 5820], [5770, 5800], [5750, 5780], [5730, 5760], [5710, 5740]],
    "B": [[5718, 5748], [5737, 5767], [5756, 5786], [5775, 5805], [5794, 5824], [5813, 5843], [5832, 5862], [5851, 5881]],
    "E": [[5690, 5720], [5670, 5700], [5650, 5680], [5630, 5660], [5870, 5900], [5890, 5920], [5910, 5940], [5930, 5960]],
    "F": [[5725, 5755], [5745, 5775], [5765, 5795], [5785, 5815], [5805, 5835], [5825, 5855], [5845, 5875], [5865, 5895]],
    "R": [[5643, 5673], [5679, 5709], [5716, 5746], [5753, 5783], [5790, 5820], [5827, 5857], [5864, 5894], [5901, 5931]],
    "D": [[5347, 5377], [5384, 5414], [5421, 5451], [5458, 5488], [5495, 5525], [5532, 5562], [5569, 5599], [5606, 5636]],
    "U": [[5300, 5330], [5323, 5353], [5341, 5371], [5359, 5389], [5377, 5407], [5395, 5425], [5413, 5443], [5431, 5461]],
    "O": [[5459, 5489], [5477, 5507], [5495, 5525], [5513, 5543], [5531, 5561], [5549, 5579], [5567, 5597], [5585, 5615]],
    "L": [[5318, 5348], [5358, 5388], [5398, 5428], [5438, 5468], [5478, 5508], [5518, 5548], [5558, 5588], [5598, 5628]],
    "H": [[5638, 5668], [5678, 5708], [5718, 5748], [5758, 5788], [5798, 5828], [5838, 5868], [5878, 5908], [5918, 5948]],
}
...
class SignalProcessor:
    ...
    def __init__(self, id, sample_rate=20e6, sample_count=1e6, center_freq=5780e6):
        ...
        self.computed_level_of_interest = 0
    ...
    def __process(self):
        ...
        if self.manual_offset_in_use:
            ...
            level_of_interest_db = min_pxx_db + 2*(abs(min_pxx_db) - abs(avg_pxx_db))
            self.computed_level_of_interest = level_of_interest_db
    ...
    def update_signals_channels(self, signals_list):
        ...
        for signal in signals_list:
            for channel, center_freq_list in channel_center_freq_list.items():
                if round(signal.peak_freq) in center_freq_list:
                    signal.channel = channel + str(center_freq_list.index(round(signal.peak_freq)))
                    break
            ...
            for channel, freq_range_list in channel_freq_range_list.items():
                for freq_range in freq_range_list:
                    if signal.peak_freq >= freq_range[0] and signal.peak_freq <= freq_range[1]:
                        signal.potential_channels.append(channel + str(freq_range_list.index(freq_range)))
                        break
